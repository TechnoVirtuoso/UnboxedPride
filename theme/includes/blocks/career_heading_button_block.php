<section class="career-heading-button-section">
    <div class="wrap-heading-button" style="background-image:url(<?php echo $block['background_image']['url'] ?>)">
        <div class="container">
            <div class="column">
                <div class="inner-column">
                    <div class="heading-content">
                        <h3 class="sub-heading"><?php echo $block['sub_heading']?></h3>
